"""
1. Run: `pip install openai agno redis newspaper4k lxml_html_clean` to install the dependencies
2. Run: `python cookbook/storage/redis_storage/redis_storage_for_workflow.py` to run the workflow
